...
**Red Cat Redemption** is a 2D top-down action-adventure game built in Unity. Set in a pixel-art Wild West world populated by cats, players explore the frontier, interact with NPC quest-givers, and engage in gunfights using a robust combat system.
## Repository Infos
